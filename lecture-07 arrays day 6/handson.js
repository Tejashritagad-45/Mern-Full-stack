...
const arrr11=[-1,2,3,-4,5];
for(let i=0;i<ar11.length;i++){
    let subArray="";
    for(let j=i;j<arrr11.length;j++){
        subArray+=arrr11[j]+" ";
...
const ar1=[-1,5,-3,2,-1,3];
//let sum=0;
let Max1=0;
for(let i=0;i<ar1.length;i++){
    let sum=0;
    for(let j=i;j<ar1.length;j++){
        sum+=ar1[j];
        if(sum>Max1){
            Max1=sum;
...
const arrr =[1,2,3,4];
maxSubArraySum(arr);
console.log(maxSubArraySum(arrr));    
...
const arrr1=[1,2,-3,0,1,-1,1];
console.log(countSumOfk(arrr1,0));
...
const arr1r=[1,2,-3,0,1,-1,1];
console.log(countSumOfk(arr1r,0));
